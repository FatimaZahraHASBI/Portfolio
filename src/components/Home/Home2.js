        ...
        <Row>
          <Col md={8} className="home-about-description">
            ...
            <p className="home-about-body">
              I am a junior software engineer, full stack web developer, and mobile developer
              <br />
              <br />
              ...
              &nbsp; like
              <i>
                <b className="purple"> React.js and Aangular</b> for the frontend part
              </i>
              <br />
              <br />
          ...
          <Col md={12} className="home-about-social">
            ...
            <ul className="home-about-social-links">
              <li className="social-icons">
                <a
                  href="https://github.com/FatimaZahraHASBI"
                  target="_blank"
                  rel="noreferrer"
              ...
              <li className="social-icons">
                <a
                  href="https://www.linkedin.com/in/fatima-zahra-hasbi-610430201/"
                  target="_blank"
                  rel="noreferrer"
                  className="icon-colour  home-social-icons"
                >
